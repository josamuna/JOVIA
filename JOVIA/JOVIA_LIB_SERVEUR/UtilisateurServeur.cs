...
namespace JOVIA_LIB_SERVEUR
{
    public class UtilisateurServeur
    {
        ...
        private List<UtilisateurServeur> lstUtilisateur;

        public List<UtilisateurServeur> LstUtilisateur
        {
            get
            {
                if (lstUtilisateur == null) lstUtilisateur = new List<UtilisateurServeur>();
