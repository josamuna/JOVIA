...
{
    public partial class ExecuteQueryServeur : UserControl
    {
        public ExecuteQueryServeur()
        {
            InitializeComponent();
        }

        private void btnCloseExecuteQuery_Click(object sender, EventArgs e)
        {
            this.Dispose();
        }
        ...
        private void btnCreateFile_Click(object sender, EventArgs e)
        {
            try
            {
                Factory1.Instance.ExecuteOneQyery(TxtQuery.Text);
