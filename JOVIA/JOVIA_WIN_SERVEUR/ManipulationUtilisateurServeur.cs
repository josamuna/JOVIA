...
{
    public partial class ManipulationUtilisateurServeur : UserControl
    {
        private UtilisateurServeur utilisateur = new UtilisateurServeur();
        private PersonneServeur personne = new PersonneServeur();
        private TelephoneServeur telephone = new TelephoneServeur();
        private CategorieUtilisateurServeur catU = new CategorieUtilisateurServeur();

        public ManipulationUtilisateurServeur()
        {
            InitializeComponent();
        }

        private void ManipulationUtilisateurServeur_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cboCategorieUtilisateur.DataSource = Factory1.Instance.GetCategorieUtilisateurs();
            }
            catch (Exception) { }

            try
            {
                dgvUser.DataSource = Factory1.Instance.GetUtilisateurs();
                dgvCatUser.DataSource = Factory1.Instance.GetCategorieUtilisateurs();
            }
            catch (Exception) { }
        ...
        {
            cboIdUtilisateur.DataSource = Factory1.Instance.GetUtilisateurs();
            cboUser.DataSource = Factory1.Instance.GetUtilisateurs();
            cboUserModPsd.DataSource = Factory1.Instance.GetUtilisateurs();
            cboGroupeUser.Items.Add("ADMINISTRATEUR");//0
            cboGroupeUser.Items.Add("INVITE");//1
        ...
        private void cmdModifieTelephone_Click(object sender, EventArgs e)
        {
            try
            {
                if (telephone != null)
                {
                    ...
                    {
                        telephone = (TelephoneServeur)dgvTelephone.SelectedRows[0].DataBoundItem;
                        ...
                        try
                        {
                            dgvTelephone.DataSource = Factory1.Instance.GetTelephones(telephone.Id_utilisateur);
                        }
                        catch (Exception) { }
                    }
                }
        ...
        private void btModifierUserName_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!txtOldUserName.Text.Equals(""))
                {
                    ...
                    {
                        Factory1.Instance.UpdateUserName(utilisateur.Nomuser, txtNewUserName.Text);
                        MessageBox.Show("Modification éffectué", "Modification", MessageBoxButtons.OK, MessageBoxIcon.Information);

                        try
                        {
                            telephone.Id_utilisateur = Convert.ToInt32(((UtilisateurServeur)cboUser.SelectedItem).Id);
                        }
                        catch (Exception) { }
            ...
            {
                MessageBox.Show("Echec" + ex.Message, "Modification", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
        ...
        private void btModifierPwdUser_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (Factory1.Instance.VerifiePassword(utilisateur.Nomuser))
                    {
                        if (!txtNewPwd.Text.Equals(""))
                        {
                            if (!txtConfNewPwd.Text.Equals(""))
                            {
                                ...
                                {
                                    Factory1.Instance.UpdatePasswordUser(utilisateur.Nomuser, utilisateur.Motpass);
                                    MessageBox.Show("Modification éffectué", "Modification", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void cmdAddTelephone_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                lblIdTelephone.Text = Factory1.Instance.ReNewIdValue(telephone).ToString();
            }
        ...
        private void cmdAddCatUser_Click(object sender, EventArgs e)
        {
            try
            {
                lblIdCatUser.Text = Factory1.Instance.ReNewIdValue(catU).ToString();
        ...
        private void dgvUser_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (dgvUser.SelectedRows.Count > 0)
            {
                ...
                utilisateur = (UtilisateurServeur)dgvUser.SelectedRows[0].DataBoundItem;
                lblIdUser.Text = utilisateur.Id.ToString();
                cboIdPersonne.Text = Factory1.Instance.GetPersonne(utilisateur.Id_personne).ToString();
                cboCategorieUtilisateur.Text = Factory1.Instance.GetCategorieUtilisateur(utilisateur.Id_categorieUtilisateur).ToString();
            ...
            try
            {
                if (Factory1.Instance.GetTelephones(utilisateur.Id).Count == 0) { dgvTelephone.DataSource = null; }
                else dgvTelephone.DataSource = Factory1.Instance.GetTelephones(utilisateur.Id);
            }
            catch (Exception) { }
        ...
        private void cboIdPersonne_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                utilisateur.Id_personne = Convert.ToInt32(((PersonneServeur)cboIdPersonne.SelectedItem).Id);
            }
            catch (Exception) { }
        }
        ...
        private void cboCategorieUtilisateur_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                utilisateur.Id_categorieUtilisateur = Convert.ToInt32(((CategorieUtilisateurServeur)cboCategorieUtilisateur.SelectedItem).Id);
            }
            catch (Exception) { }
        }
        ...
        private void cboUserModPsd_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                telephone.Id_utilisateur = Convert.ToInt32(((UtilisateurServeur)cboUserModPsd.SelectedItem).Id);
            }
            catch (Exception) { }
        }
        ...
        private void cboIdUtilisateur_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                telephone.Id_utilisateur = Convert.ToInt32(((UtilisateurServeur)cboIdUtilisateur.SelectedItem).Id);
            }
            catch (Exception) { }
        }
        ...
        private void cmdAddUser_Click(object sender, EventArgs e)
        {
            try
            {
                lblIdUser.Text = Factory1.Instance.ReNewIdValue(utilisateur).ToString();
                txtUserName.Clear();
                txtPwd.Clear();
                txtConfirmPwd.Clear();
                txtUserName.Focus();
        ...
        private void cmdSearchUser_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                lblIdUser.Text = Factory1.Instance.SearchUtilisateur(userName)[0];
                cboIdPersonne.Text = Factory1.Instance.GetPersonne(Convert.ToInt32(Factory1.Instance.SearchUtilisateur(userName)[1])).Nom + " " +
                Factory1.Instance.GetPersonne(Convert.ToInt32(Factory1.Instance.SearchUtilisateur(userName)[1])).Postnom + " " +
                Factory1.Instance.GetPersonne(Convert.ToInt32(Factory1.Instance.SearchUtilisateur(userName)[1])).Prenom;
                cboCategorieUtilisateur.Text = Factory1.Instance.GetCategorieUtilisateur(Convert.ToInt32(Factory1.Instance.SearchUtilisateur(userName)[2])).Designation;
                txtUserName.Text = Factory1.Instance.SearchUtilisateur(userName)[3];
            }
            catch (Exception ex)
            {
        ...
        private void dgvCatUser_SelectionChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dgvCatUser.SelectedRows.Count > 0)
                {
                    ...
                    catU = (CategorieUtilisateurServeur)dgvCatUser.SelectedRows[0].DataBoundItem;
                    lblIdCatUser.Text = catU.Id.ToString();
                    cboGroupeUser.Text = catU.Groupe.ToString();
