    ...
    public partial class PersonneCarteServeur : UserControl
    {
        ...
        private void refreshPersonne()
        {
            ...
            if (dgvPersonne.RowCount > 0)
            {
                ...
                btnSearchPersonne.Enabled = true;
        ...
        private void PersonneCarte_Load(object sender, EventArgs e)
        {
            ...
            if (dgvPersonne.RowCount <= 0)
            {
                ...
                btnSearchPersonne.Enabled = false;
                //btnDeletePersonne.Enabled = false;
            }
        ...
        private void dgvPersonne_SelectionChanged(object sender, EventArgs e)
        {
            try
            {
                if (dgvPersonne.SelectedRows.Count > 0)
                {
                    ...
                    if (personne.Id_pere.HasValue) cboNomPerePersonne.Text = Factory1.Instance.GetPersonne(Convert.ToInt32(personne.Id_pere)).Nom + " " + Factory1.Instance.GetPersonne(Convert.ToInt32(personne.Id_pere)).Postnom + " " + Factory1.Instance.GetPersonne(Convert.ToInt32(personne.Id_pere)).Prenom;
                    else cboNomPerePersonne.Text = "";
                    if (personne.Id_mere.HasValue) cboNomMerePersonne.Text = Factory1.Instance.GetPersonne(Convert.ToInt32(personne.Id_mere)).Nom + " " + Factory1.Instance.GetPersonne(Convert.ToInt32(personne.Id_mere)).Postnom + " " + Factory1.Instance.GetPersonne(Convert.ToInt32(personne.Id_mere)).Prenom;
        ...
        private void btnSearchCarte_Click(object sender, EventArgs e)
        {
