...
namespace JOVIA_WIN
{
    public partial class ComCheffQuartierLoc : UserControl
    {
        VilleTeritoire villeTer = new VilleTeritoire();
        CommuneChefferieSecteur comChefSect = new CommuneChefferieSecteur();
        QuartierLocalite quartierLoc = new QuartierLocalite();

        public ComCheffQuartierLoc()
        {
            InitializeComponent();
        }
        ...
        {
            dgvQuartierLoc.DataSource = Factory.Instance.GetQuartierLocalites();
        ...
        {
            dgvComChefSect.DataSource = Factory.Instance.GetCommuneChefferieSecteurs();
        ...
        private void ComCheffQuartierLoc_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                cboRechercheCommChefSect.DataSource = Factory.Instance.GetCommuneChefferieSecteurs();
                cboRechercheQuartLocalit.DataSource = Factory.Instance.GetQuartierLocalites();
                cboIdComChefSect.DataSource = Factory.Instance.GetCommuneChefferieSecteurs();
                cboVilleTeritoire.DataSource = Factory.Instance.GetVilleTeritoires();
        ...
        private void dgvQuartierLoc_SelectionChanged(object sender, EventArgs e)
        {
            try
            {
                if (dgvQuartierLoc.SelectedRows.Count > 0)
                {
                    ...
                    quartierLoc = (QuartierLocalite)dgvQuartierLoc.SelectedRows[0].DataBoundItem;
                    lblIdQuartierLoc.Text = quartierLoc.Id.ToString();
                    cboIdComChefSect.Text = Factory.Instance.GetCommuneChefferieSecteur(quartierLoc.Id_communeChefferieSecteur).Designation;
        ...
        private void cboVilleTeritoire_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                comChefSect.Id_VilleTeritoire = Convert.ToInt32(((VilleTeritoire)cboVilleTeritoire.SelectedItem).Id);
            }catch(Exception){}
        }
        ...
        private void cboIdComChefSect_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                quartierLoc.Id_communeChefferieSecteur = Convert.ToInt32(((CommuneChefferieSecteur)cboIdComChefSect.SelectedItem).Id);
                lblIdComChefSect.Text = Convert.ToString(((CommuneChefferieSecteur)cboIdComChefSect.SelectedItem).Id);
                txtDesignationComChefSect.Text = Convert.ToString(((CommuneChefferieSecteur)cboIdComChefSect.SelectedItem).Designation);
                txtSuperficieComChefSect.Text = Convert.ToString(((CommuneChefferieSecteur)cboIdComChefSect.SelectedItem).Superficie);
                cboVilleTeritoire.Text = Factory.Instance.GetVilleTeritoire(Convert.ToInt32(Convert.ToInt32(((CommuneChefferieSecteur)cboIdComChefSect.SelectedItem).Id_VilleTeritoire))).Designation;
            }
            catch (Exception) { }
        }
        ...
        private void cboRechercheQuartLocalit_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                quartierLoc = (QuartierLocalite)cboRechercheQuartLocalit.SelectedItem;
                lblIdQuartierLoc.Text = quartierLoc.Id.ToString();
                cboIdComChefSect.Text = Factory.Instance.GetCommuneChefferieSecteur(quartierLoc.Id_communeChefferieSecteur).Designation;
                txtDesignationQuartierLoc.Text = Convert.ToString(quartierLoc.Designation);
                txtSuperficieQuartierLoc.Text = Convert.ToString(quartierLoc.Superficie);
        ...
        private void btnAddComChefSect_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                lblIdComChefSect.Text = Factory.Instance.ReNewIdValue(comChefSect).ToString();
                txtDesignationComChefSect.Clear();
                txtSuperficieComChefSect.Clear();
                txtDesignationComChefSect.Focus();
        ...
        private void btnRefrehComChefSect_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Erreur lors de l'actualisation des commune-Chefferie-Secteur", "Erreur", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
        ...
        private void btnAddQuartierLoc_Click(object sender, EventArgs e)
        {
            ...
            {
                //considerez comme nouveau
                lblIdQuartierLoc.Text = Factory.Instance.ReNewIdValue(quartierLoc).ToString();
                txtDesignationQuartierLoc.Clear();
                txtSuperficieQuartierLoc.Clear();
                txtDesignationQuartierLoc.Focus();
        ...
        private void btnRefreshQuartierLoc_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Erreur lors de l'actualisation des Quartier-Localité", "Erreur", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
