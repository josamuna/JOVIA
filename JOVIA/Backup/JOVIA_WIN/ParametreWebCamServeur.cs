...
namespace JOVIA_WIN
{
    public partial class ParametreWebCamServeur : UserControl
    {
        ...
        private void ParametreWebCamServeur_Load(object sender, EventArgs e)
        {
            try
            {
