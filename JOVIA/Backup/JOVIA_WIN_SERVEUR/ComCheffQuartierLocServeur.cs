    ...
    public partial class ComCheffQuartierLocServeur : UserControl
    {
        ...
        private void refreshQuartierLoc()
        {
            ...
            if (dgvQuartierLoc.RowCount > 0)
            {
                ...
                btnSearchQuartierLoc.Enabled = true;
            }
        ...
        private void refreshComChefSect()
        {
            ...
            if (dgvComChefSect.RowCount > 0)
            {
                ...
                btnSearchComChefSect.Enabled = true;
            }
        ...
        private void ComCheffQuartierLoc_Load(object sender, EventArgs e)
        {
            ...
            if (dgvComChefSect.RowCount <= 0)
            {
                ...
                btnSearchComChefSect.Enabled = false;
            }
            ...
            if (dgvQuartierLoc.RowCount <= 0)
            {
                ...
                btnSearchQuartierLoc.Enabled = false;
            } 
        }
        ...
        private void btnRefreshQuartierLoc_Click(object sender, EventArgs e)
        {
            ...
            dgRechercheQuartier.DataSource = null;
        }
        ...
        private void btnRefrehComChefSect_Click(object sender, EventArgs e)
        {
            ...
            dgRechercheComm.DataSource = null;
        }
        ...
        private void btnSearchComChefSect_Click(object sender, EventArgs e)
        {
            string valueDesi = Interaction.InputBox("Veuillez saisir la désignation de la Commune,Chefferie ou Secteur à rechercher", "Recherche Commune/Chefferie/Secteur", "", 100, 100);

            try
            {
                dgRechercheComm.DataSource = Factory1.Instance.SearchCommuneChefferieSecteur(valueDesi);

                //On rend inisible certaines colonne des DataGridView qui recup les dataproperty
                //correspondant aux noms des accesseurs
                int col = 0;
                foreach (DataGridViewColumn dgvc in dgRechercheComm.Columns)
                {
                    if (dgvc.DataPropertyName == "Id") dgvc.Visible = false;
                    else if (dgvc.DataPropertyName == "Id_VilleTeritoire") dgvc.Visible = false;
                    dgvComChefSect.AutoResizeColumn(col);
        ...
        private void btnSearchQuartierLoc_Click(object sender, EventArgs e)
        {
            string valueDesi = Interaction.InputBox("Veuillez saisir la désignation du Quartier ou de la Localité à rechercher", "Recherche Quartier/Localité", "", 100, 100);

            try
            {
                dgRechercheQuartier.DataSource = Factory1.Instance.SearchQuartierLocalite(valueDesi);

                //On rend inisible certaines colonne des DataGridView qui recup les dataproperty
                //correspondant aux noms des accesseurs
                int col = 0;

                foreach (DataGridViewColumn dgvc in dgRechercheQuartier.Columns)
                {
                    if (dgvc.DataPropertyName == "Id") dgvc.Visible = false;
                    else if (dgvc.DataPropertyName == "Id_communeChefferieSecteur") dgvc.Visible = false;
                    dgvQuartierLoc.AutoResizeColumn(col);
        ...
        private void dgRechercheComm_SelectionChanged(object sender, EventArgs e)
        {
            try
            {
                if (dgRechercheComm.SelectedRows.Count > 0)
                {
                    comChefSect = (CommuneChefferieSecteurServeur)dgRechercheComm.SelectedRows[0].DataBoundItem;
                    lblIdComChefSect.Text = comChefSect.Id.ToString();
        ...
        private void dgRechercheQuartier_SelectionChanged(object sender, EventArgs e)
        {
            try
            {
                if (dgRechercheQuartier.SelectedRows.Count > 0)
                {
                    quartierLoc = (QuartierLocaliteServeur)dgRechercheQuartier.SelectedRows[0].DataBoundItem;
                    lblIdQuartierLoc.Text = quartierLoc.Id.ToString();
